defmodule RailwayIpc.Adapters.RabbitMQ.Client.Impl do
  @moduledoc false
  ...
  @callback ack(AMQP.Channel.t(), integer(), keyword()) :: :ok | AMQP.Basic.error()
  @callback reject(AMQP.Channel.t(), integer(), keyword()) :: :ok | AMQP.Basic.error()
